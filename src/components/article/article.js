...
function articleMaker(articleObj){
  ...
  articleWrapper.appendChild(articleFirstPar);
  articleWrapper.appendChild(articleSecondPar);
  articleWrapper.appendChild(articleThirdPar);
  articleWrapper.appendChild(expandButton);

  articleTitle.textContent = articleObj.title;
  articleDate.textContent = articleObj.date;
  articleFirstPar.textContent = articleObj.firstParagraph;
  articleSecondPar.textContent = articleObj.secondParagraph;
  articleThirdPar.textContent = articleObj.thirdParagraph;
